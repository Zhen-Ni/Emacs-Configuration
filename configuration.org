...
#+begin_src emacs-lisp :var conf-table=conf-table
  ...
  (if (not (equal font "default"))
      (progn (set-face-attribute 'default nil :font font)
             (set-face-attribute 'fixed-pitch nil :font font))
    )
  (if (not (equal font-size "default"))
...
the buffer. See [[https://github.com/jorgenschaefer/elpy/issues/1729#issuecomment-558204483][github issue]].
#+begin_src emacs-lisp
