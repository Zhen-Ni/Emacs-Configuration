...
#+end_src
*** Use use-package
Make sure =use-package= is installed in the first place.
...
*This Mode is disabled because of too much inconsistent behaviors with the built-in one.*
...
Abaqus inp mode. This mode needs manually installation.
