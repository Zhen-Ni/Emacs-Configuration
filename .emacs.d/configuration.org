...
Use ~all-the-icons-check-installation~ to check whether ~all-the-icons~
...
#+begin_src emacs-lisp
  ...
  (defun all-the-icons-installed ()
    "Check if all-the-icons fonts have been installed."
    (find-font (font-spec :name "all-the-icons"))
    )

  (unless (all-the-icons-installed)
...
#+begin_src emacs-lisp
  (setq projectile-mode-line-prefix
        (if (and t (all-the-icons-installed))          ;; TO BE FINISHED!!!!
  	  (concat " " (all-the-icons-octicon
  		   "repo"
