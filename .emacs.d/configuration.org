...
| Field      | Value                                     |
|------------+-------------------------------------------|
| model      | openai/Pro/zai-org/GLM-5.1                |
| weak-model | openai/zai-org/GLM-4.5-Air                |
...
#+begin_src emacs-lisp :var conf=aider-conf
  (let ((path (cadr (assoc "path" conf)))
        ...
        (weak-model (cadr (assoc "weak-model" conf))))
    (if (not (string-equal path "default"))
        (setq aidermacs-program path)
      )
    (if (not (string-equal model "default"))
        (setq aidermacs-default-model model))
    (if (not (string-equal weak-model "default"))
