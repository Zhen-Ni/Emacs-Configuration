...
#+begin_src emacs-lisp
  (defun get-vc-mode-with-icon ()
    ...
    (when (and vc-mode (all-the-icons-installed))
  ...
  '("%e" mode-line-front-space
   ...
   ;; The default value of the next block is:
   ;; (vc-mode vc-mode)
   ;; I want it to be evaluated online, to avoid out-of-dated version
   ;; display.
...
#+begin_src emacs-lisp
  (setq projectile-mode-line-prefix
        (if (and nil (all-the-icons-installed))          ;; TO BE FINISHED!!!!
