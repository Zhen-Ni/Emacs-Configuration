...
Set default path to current project root.

#+begin_src emacs-lisp
  (defun project-set-default-directory ()
...
Set python default path to current project root.

#+begin_src emacs-lisp
  (add-hook 'python-mode-hook #'project-set-default-directory)
#+end_src
...
**** Default Path
Set qml default path to current project root.

#+begin_src emacs-lisp
  (add-hook 'qml-mode-hook #'project-set-default-directory)
#+end_src
