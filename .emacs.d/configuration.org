...
| cjk-font           | default |                            |
| cjk-font-size      | 38      | font height in units of pt |
...
with size 110, and default cjk font is "微软雅黑" with size 250.
...
*** COMMENT Language Coding System
...
#+begin_src emacs-lisp
  (use-package minions
    ...
    (setq minions-mode-line-lighter "Modes")
    (minions-mode 1)
    )
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq lsp-modeline-code-action-fallback-icon "Hints")
